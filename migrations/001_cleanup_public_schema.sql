-- Mini-Agent Schema Cleanup Script
-- This script removes accidentally created tables from public schema
-- and applies the corrected migration to the mini_agent schema
--
-- Run this if tables were created in public schema instead of mini_agent schema

-- ============================================================================
-- CLEANUP: DROP PUBLIC SCHEMA TABLES (if they exist)
-- ============================================================================

-- Check if tables exist in public schema and drop them
DO $$
DECLARE
    table_name TEXT;
BEGIN
...
-- This will create tables in mini_agent schema instead of public
...
SELECT 
    'Schema cleanup and recreation completed successfully!' as status,
    NOW() as completed_at;
