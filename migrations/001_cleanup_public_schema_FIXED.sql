-- ============================================================================
-- STEP 2: COMPLETE SCHEMA CLEANUP AND RECREATION (FIXED VERSION)
-- ============================================================================
...
-- Initialize system state (FIXED: Use proper JSON construction)
INSERT INTO mini_agent.mini_agent_system_state (state_key, state_value, state_type, health_score) 
VALUES
('schema_cleanup_complete', 
 jsonb_build_object(
   'completed_at', NOW(),
   'status', 'cleaned_up_and_recreated'
 ), 
 'operational', 
 1.00
)
