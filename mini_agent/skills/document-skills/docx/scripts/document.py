...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "MiniMax-M2", initials: str = "C"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "MiniMax-M2")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "MiniMax-M2")
