...
class Config(BaseModel):
    ...
    def from_yaml(cls, config_path: str | Path) -> "Config":
        ...
        print(f"🔍 Raw config data: {data}")  # Debug line
        ...
        def substitute_env_vars(obj):
            ...
            if isinstance(obj, dict):
                ...
                value = os.getenv(env_var, obj)  # Return original if env var not found
                print(f"🔄 Substituting {obj} -> {value}")  # Debug line
                return value
            else:
                return obj
        ...
        print(f"🔍 After substitution: {data}")  # Debug line
