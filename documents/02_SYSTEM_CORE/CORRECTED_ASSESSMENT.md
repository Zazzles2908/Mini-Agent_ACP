...
2. **Should Use OpenAI SDK format**: For GLM functionality instead of custom Z.AI implementation
...
- Should use OpenAI SDK format instead of custom implementation
- Should connect to original EXAI-MCP, not create generic config

## Next Steps
1. Ask user what specific issues need fixing
2. Replace Z.AI client with OpenAI SDK format if requested
...
3. Should I use OpenAI SDK format for GLM?
