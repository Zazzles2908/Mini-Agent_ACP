...
- [开发指南](#开发指南)
  ...
  - [3. 扩展能力](#3-扩展能力)
    ...
    - [3.3 自定义存储](#33-自定义存储)
    - [3.4 初始化 MiniMax-M2 Skills（推荐）](#34-初始化-minimax-skills推荐)
...
### 3.4 初始化 MiniMax-M2 Skills（推荐）

本项目通过 Git Submodule 的方式集成了 MiniMax-M2 官方技能库。首次克隆项目后，请执行以下命令来初始化技能库：
...
- [MiniMax-M2 Skills 官方文档](https://docs.minimax.com/zh-CN/docs/agents-and-tools/agent-skills)
