# Complete Demonstration: Z.AI Web Search Optimal Usage
...
**Result 2:** Quick Start - Z.AI DEVELOPER DOCUMENT
🔗 Source: https://docs.z.ai/devpack/quick-start
📝 Content Preview: We recommend storing it in environment variables or configuration files. 4. Select Coding Tool. GLM ...
✅ Citations: Enabled
...
### ✅ **Use Case Workflow**:
1. **Search First** - Find relevant pages (what we just demonstrated)
2. **Get URLs** - Direct links to the documentation
3. **Visit Pages** - Access full content from the URLs
4. **Cite Sources** - Use the provided citations in analysis
...
**Why aren't you seeing full information?**

Because **web search** and **web reading** are **different APIs**:

- **Web Search** = Find pages + get snippets (✅ Working perfectly)
- **Web Reading** = Get full page content (⚠️ API configuration issue)

The search tool provides exactly what it's designed to do: **find relevant pages and give you snippets with URLs so you can visit the full content yourself**.

This is the **standard and expected behavior** for web search tools!